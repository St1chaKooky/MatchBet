...
class ListPrognozAccountWidget extends StatefulWidget {
  final String id;
  const ListPrognozAccountWidget({super.key, required this.id});

  @override
  State<ListPrognozAccountWidget> createState() =>
      _ListPrognozAccountWidgetState();
}

class _ListPrognozAccountWidgetState extends State<ListPrognozAccountWidget> {
